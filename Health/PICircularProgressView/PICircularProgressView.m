...
- (void)drawRect:(CGRect)rect
{
    ...
    if (_showText && _textColor)
    {
        ...
        if (title) {
            [title drawAtPoint:CGPointMake(80, 52) forWidth:54 withFont:font3 lineBreakMode:NSLineBreakByWordWrapping];
        }
        
        if (goal) {
            [goal drawAtPoint:CGPointMake(66+(8-[goal length])*3, 135) forWidth:68-(8-[goal length])*3 withFont:font2 lineBreakMode:NSLineBreakByWordWrapping];
        }
